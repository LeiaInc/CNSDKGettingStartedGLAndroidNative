...
#if defined(WIN32)
    #ifdef OVR_GLE_EXPORTS
        #define GLE_CLASS_EXPORT __declspec(dllexport)
    #else
        #define GLE_CLASS_EXPORT // __declspec(dllimport)
    #endif
#else
    #define GLE_CLASS_EXPORT
#endif
...
#else
#define GLEGetCurrentFunction(x, ...) \
    ((void)[]{static_assert(OVR::GLEContext::x##_enabled, #x " must be explicitly enabled before use. Search for GLE_IMPL(..., " #x ") in CAPI_GLE.h");}, \
    OVR::GLEContext::GetCurrentContext()->x##_Impl(__VA_ARGS__))
#define GLEGetCurrentVariable(x) OVR::GLEContext::GetCurrentContext()->x
#endif
...
#define glCopyTexSubImage3D(...) GLEGetCurrentFunction(glCopyTexSubImage3D, __VA_ARGS__)
#define glDrawRangeElements(...) GLEGetCurrentFunction(glDrawRangeElements, __VA_ARGS__)
#define glTexImage3D(...) GLEGetCurrentFunction(glTexImage3D, __VA_ARGS__)
#define glTexSubImage3D(...) GLEGetCurrentFunction(glTexSubImage3D, __VA_ARGS__)
...
#define glActiveTexture(...) GLEGetCurrentFunction(glActiveTexture, __VA_ARGS__)
#define glClientActiveTexture(...) GLEGetCurrentFunction(glClientActiveTexture, __VA_ARGS__)
#define glCompressedTexImage1D(...) GLEGetCurrentFunction(glCompressedTexImage1D, __VA_ARGS__)
#define glCompressedTexImage2D(...) GLEGetCurrentFunction(glCompressedTexImage2D, __VA_ARGS__)
#define glCompressedTexImage3D(...) GLEGetCurrentFunction(glCompressedTexImage3D, __VA_ARGS__)
#define glCompressedTexSubImage1D(...) GLEGetCurrentFunction(glCompressedTexSubImage1D, __VA_ARGS__)
#define glCompressedTexSubImage2D(...) GLEGetCurrentFunction(glCompressedTexSubImage2D, __VA_ARGS__)
#define glCompressedTexSubImage3D(...) GLEGetCurrentFunction(glCompressedTexSubImage3D, __VA_ARGS__)
#define glGetCompressedTexImage(...) GLEGetCurrentFunction(glGetCompressedTexImage, __VA_ARGS__)
#define glLoadTransposeMatrixd(...) GLEGetCurrentFunction(glLoadTransposeMatrixd, __VA_ARGS__)
#define glLoadTransposeMatrixf(...) GLEGetCurrentFunction(glLoadTransposeMatrixf, __VA_ARGS__)
#define glMultTransposeMatrixd(...) GLEGetCurrentFunction(glMultTransposeMatrixd, __VA_ARGS__)
#define glMultTransposeMatrixf(...) GLEGetCurrentFunction(glMultTransposeMatrixf, __VA_ARGS__)
#define glMultiTexCoord1d(...) GLEGetCurrentFunction(glMultiTexCoord1d, __VA_ARGS__)
#define glMultiTexCoord1dv(...) GLEGetCurrentFunction(glMultiTexCoord1dv, __VA_ARGS__)
#define glMultiTexCoord1f(...) GLEGetCurrentFunction(glMultiTexCoord1f, __VA_ARGS__)
#define glMultiTexCoord1fv(...) GLEGetCurrentFunction(glMultiTexCoord1fv, __VA_ARGS__)
#define glMultiTexCoord1i(...) GLEGetCurrentFunction(glMultiTexCoord1i, __VA_ARGS__)
#define glMultiTexCoord1iv(...) GLEGetCurrentFunction(glMultiTexCoord1iv, __VA_ARGS__)
#define glMultiTexCoord1s(...) GLEGetCurrentFunction(glMultiTexCoord1s, __VA_ARGS__)
#define glMultiTexCoord1sv(...) GLEGetCurrentFunction(glMultiTexCoord1sv, __VA_ARGS__)
#define glMultiTexCoord2d(...) GLEGetCurrentFunction(glMultiTexCoord2d, __VA_ARGS__)
#define glMultiTexCoord2dv(...) GLEGetCurrentFunction(glMultiTexCoord2dv, __VA_ARGS__)
#define glMultiTexCoord2f(...) GLEGetCurrentFunction(glMultiTexCoord2f, __VA_ARGS__)
#define glMultiTexCoord2fv(...) GLEGetCurrentFunction(glMultiTexCoord2fv, __VA_ARGS__)
#define glMultiTexCoord2i(...) GLEGetCurrentFunction(glMultiTexCoord2i, __VA_ARGS__)
#define glMultiTexCoord2iv(...) GLEGetCurrentFunction(glMultiTexCoord2iv, __VA_ARGS__)
#define glMultiTexCoord2s(...) GLEGetCurrentFunction(glMultiTexCoord2s, __VA_ARGS__)
#define glMultiTexCoord2sv(...) GLEGetCurrentFunction(glMultiTexCoord2sv, __VA_ARGS__)
#define glMultiTexCoord3d(...) GLEGetCurrentFunction(glMultiTexCoord3d, __VA_ARGS__)
#define glMultiTexCoord3dv(...) GLEGetCurrentFunction(glMultiTexCoord3dv, __VA_ARGS__)
#define glMultiTexCoord3f(...) GLEGetCurrentFunction(glMultiTexCoord3f, __VA_ARGS__)
#define glMultiTexCoord3fv(...) GLEGetCurrentFunction(glMultiTexCoord3fv, __VA_ARGS__)
#define glMultiTexCoord3i(...) GLEGetCurrentFunction(glMultiTexCoord3i, __VA_ARGS__)
#define glMultiTexCoord3iv(...) GLEGetCurrentFunction(glMultiTexCoord3iv, __VA_ARGS__)
#define glMultiTexCoord3s(...) GLEGetCurrentFunction(glMultiTexCoord3s, __VA_ARGS__)
#define glMultiTexCoord3sv(...) GLEGetCurrentFunction(glMultiTexCoord3sv, __VA_ARGS__)
#define glMultiTexCoord4d(...) GLEGetCurrentFunction(glMultiTexCoord4d, __VA_ARGS__)
#define glMultiTexCoord4dv(...) GLEGetCurrentFunction(glMultiTexCoord4dv, __VA_ARGS__)
#define glMultiTexCoord4f(...) GLEGetCurrentFunction(glMultiTexCoord4f, __VA_ARGS__)
#define glMultiTexCoord4fv(...) GLEGetCurrentFunction(glMultiTexCoord4fv, __VA_ARGS__)
#define glMultiTexCoord4i(...) GLEGetCurrentFunction(glMultiTexCoord4i, __VA_ARGS__)
#define glMultiTexCoord4iv(...) GLEGetCurrentFunction(glMultiTexCoord4iv, __VA_ARGS__)
#define glMultiTexCoord4s(...) GLEGetCurrentFunction(glMultiTexCoord4s, __VA_ARGS__)
#define glMultiTexCoord4sv(...) GLEGetCurrentFunction(glMultiTexCoord4sv, __VA_ARGS__)
#define glSampleCoverage(...) GLEGetCurrentFunction(glSampleCoverage, __VA_ARGS__)
...
#define glBlendColor(...) GLEGetCurrentFunction(glBlendColor, __VA_ARGS__)
#define glBlendEquation(...) GLEGetCurrentFunction(glBlendEquation, __VA_ARGS__)
#define glBlendFuncSeparate(...) GLEGetCurrentFunction(glBlendFuncSeparate, __VA_ARGS__)
#define glFogCoordPointer(...) GLEGetCurrentFunction(glFogCoordPointer, __VA_ARGS__)
#define glFogCoordd(...) GLEGetCurrentFunction(glFogCoordd, __VA_ARGS__)
#define glFogCoorddv(...) GLEGetCurrentFunction(glFogCoorddv, __VA_ARGS__)
#define glFogCoordf(...) GLEGetCurrentFunction(glFogCoordf, __VA_ARGS__)
#define glFogCoordfv(...) GLEGetCurrentFunction(glFogCoordfv, __VA_ARGS__)
#define glMultiDrawArrays(...) GLEGetCurrentFunction(glMultiDrawArrays, __VA_ARGS__)
#define glMultiDrawElements(...) GLEGetCurrentFunction(glMultiDrawElements, __VA_ARGS__)
#define glPointParameterf(...) GLEGetCurrentFunction(glPointParameterf, __VA_ARGS__)
#define glPointParameterfv(...) GLEGetCurrentFunction(glPointParameterfv, __VA_ARGS__)
#define glPointParameteri(...) GLEGetCurrentFunction(glPointParameteri, __VA_ARGS__)
#define glPointParameteriv(...) GLEGetCurrentFunction(glPointParameteriv, __VA_ARGS__)
#define glSecondaryColor3b(...) GLEGetCurrentFunction(glSecondaryColor3b, __VA_ARGS__)
#define glSecondaryColor3bv(...) GLEGetCurrentFunction(glSecondaryColor3bv, __VA_ARGS__)
#define glSecondaryColor3d(...) GLEGetCurrentFunction(glSecondaryColor3d, __VA_ARGS__)
#define glSecondaryColor3dv(...) GLEGetCurrentFunction(glSecondaryColor3dv, __VA_ARGS__)
#define glSecondaryColor3f(...) GLEGetCurrentFunction(glSecondaryColor3f, __VA_ARGS__)
#define glSecondaryColor3fv(...) GLEGetCurrentFunction(glSecondaryColor3fv, __VA_ARGS__)
#define glSecondaryColor3i(...) GLEGetCurrentFunction(glSecondaryColor3i, __VA_ARGS__)
#define glSecondaryColor3iv(...) GLEGetCurrentFunction(glSecondaryColor3iv, __VA_ARGS__)
#define glSecondaryColor3s(...) GLEGetCurrentFunction(glSecondaryColor3s, __VA_ARGS__)
#define glSecondaryColor3sv(...) GLEGetCurrentFunction(glSecondaryColor3sv, __VA_ARGS__)
#define glSecondaryColor3ub(...) GLEGetCurrentFunction(glSecondaryColor3ub, __VA_ARGS__)
#define glSecondaryColor3ubv(...) GLEGetCurrentFunction(glSecondaryColor3ubv, __VA_ARGS__)
#define glSecondaryColor3ui(...) GLEGetCurrentFunction(glSecondaryColor3ui, __VA_ARGS__)
#define glSecondaryColor3uiv(...) GLEGetCurrentFunction(glSecondaryColor3uiv, __VA_ARGS__)
#define glSecondaryColor3us(...) GLEGetCurrentFunction(glSecondaryColor3us, __VA_ARGS__)
#define glSecondaryColor3usv(...) GLEGetCurrentFunction(glSecondaryColor3usv, __VA_ARGS__)
#define glSecondaryColorPointer(...) GLEGetCurrentFunction(glSecondaryColorPointer, __VA_ARGS__)
#define glWindowPos2d(...) GLEGetCurrentFunction(glWindowPos2d, __VA_ARGS__)
#define glWindowPos2dv(...) GLEGetCurrentFunction(glWindowPos2dv, __VA_ARGS__)
#define glWindowPos2f(...) GLEGetCurrentFunction(glWindowPos2f, __VA_ARGS__)
#define glWindowPos2fv(...) GLEGetCurrentFunction(glWindowPos2fv, __VA_ARGS__)
#define glWindowPos2i(...) GLEGetCurrentFunction(glWindowPos2i, __VA_ARGS__)
#define glWindowPos2iv(...) GLEGetCurrentFunction(glWindowPos2iv, __VA_ARGS__)
#define glWindowPos2s(...) GLEGetCurrentFunction(glWindowPos2s, __VA_ARGS__)
#define glWindowPos2sv(...) GLEGetCurrentFunction(glWindowPos2sv, __VA_ARGS__)
#define glWindowPos3d(...) GLEGetCurrentFunction(glWindowPos3d, __VA_ARGS__)
#define glWindowPos3dv(...) GLEGetCurrentFunction(glWindowPos3dv, __VA_ARGS__)
#define glWindowPos3f(...) GLEGetCurrentFunction(glWindowPos3f, __VA_ARGS__)
#define glWindowPos3fv(...) GLEGetCurrentFunction(glWindowPos3fv, __VA_ARGS__)
#define glWindowPos3i(...) GLEGetCurrentFunction(glWindowPos3i, __VA_ARGS__)
#define glWindowPos3iv(...) GLEGetCurrentFunction(glWindowPos3iv, __VA_ARGS__)
#define glWindowPos3s(...) GLEGetCurrentFunction(glWindowPos3s, __VA_ARGS__)
#define glWindowPos3sv(...) GLEGetCurrentFunction(glWindowPos3sv, __VA_ARGS__)
...
#define glBeginQuery(...) GLEGetCurrentFunction(glBeginQuery, __VA_ARGS__)
#define glBindBuffer(...) GLEGetCurrentFunction(glBindBuffer, __VA_ARGS__)
#define glBufferData(...) GLEGetCurrentFunction(glBufferData, __VA_ARGS__)
#define glBufferSubData(...) GLEGetCurrentFunction(glBufferSubData, __VA_ARGS__)
#define glDeleteBuffers(...) GLEGetCurrentFunction(glDeleteBuffers, __VA_ARGS__)
#define glDeleteQueries(...) GLEGetCurrentFunction(glDeleteQueries, __VA_ARGS__)
#define glEndQuery(...) GLEGetCurrentFunction(glEndQuery, __VA_ARGS__)
#define glGenBuffers(...) GLEGetCurrentFunction(glGenBuffers, __VA_ARGS__)
#define glGenQueries(...) GLEGetCurrentFunction(glGenQueries, __VA_ARGS__)
#define glGetBufferParameteriv(...) GLEGetCurrentFunction(glGetBufferParameteriv, __VA_ARGS__)
#define glGetBufferPointerv(...) GLEGetCurrentFunction(glGetBufferPointerv, __VA_ARGS__)
#define glGetBufferSubData(...) GLEGetCurrentFunction(glGetBufferSubData, __VA_ARGS__)
#define glGetQueryObjectiv(...) GLEGetCurrentFunction(glGetQueryObjectiv, __VA_ARGS__)
#define glGetQueryObjectuiv(...) GLEGetCurrentFunction(glGetQueryObjectuiv, __VA_ARGS__)
#define glGetQueryiv(...) GLEGetCurrentFunction(glGetQueryiv, __VA_ARGS__)
#define glIsBuffer(...) GLEGetCurrentFunction(glIsBuffer, __VA_ARGS__)
#define glIsQuery(...) GLEGetCurrentFunction(glIsQuery, __VA_ARGS__)
#define glMapBuffer(...) GLEGetCurrentFunction(glMapBuffer, __VA_ARGS__)
#define glUnmapBuffer(...) GLEGetCurrentFunction(glUnmapBuffer, __VA_ARGS__)
#define glBindSampler(...) GLEGetCurrentFunction(glBindSampler, __VA_ARGS__)
#define glDrawElementsBaseVertex(...) GLEGetCurrentFunction(glDrawElementsBaseVertex, __VA_ARGS__)
...
#define glAttachShader(...) GLEGetCurrentFunction(glAttachShader, __VA_ARGS__)
#define glBindAttribLocation(...) GLEGetCurrentFunction(glBindAttribLocation, __VA_ARGS__)
#define glBlendEquationSeparate(...) GLEGetCurrentFunction(glBlendEquationSeparate, __VA_ARGS__)
#define glCompileShader(...) GLEGetCurrentFunction(glCompileShader, __VA_ARGS__)
#define glCreateProgram(...) GLEGetCurrentFunction(glCreateProgram, __VA_ARGS__)
#define glCreateShader(...) GLEGetCurrentFunction(glCreateShader, __VA_ARGS__)
#define glDeleteProgram(...) GLEGetCurrentFunction(glDeleteProgram, __VA_ARGS__)
#define glDeleteShader(...) GLEGetCurrentFunction(glDeleteShader, __VA_ARGS__)
#define glDetachShader(...) GLEGetCurrentFunction(glDetachShader, __VA_ARGS__)
#define glDisableVertexAttribArray(...) GLEGetCurrentFunction(glDisableVertexAttribArray, __VA_ARGS__)
#define glDrawBuffers(...) GLEGetCurrentFunction(glDrawBuffers, __VA_ARGS__)
#define glEnableVertexAttribArray(...) GLEGetCurrentFunction(glEnableVertexAttribArray, __VA_ARGS__)
#define glGetActiveAttrib(...) GLEGetCurrentFunction(glGetActiveAttrib, __VA_ARGS__)
#define glGetActiveUniform(...) GLEGetCurrentFunction(glGetActiveUniform, __VA_ARGS__)
#define glGetAttachedShaders(...) GLEGetCurrentFunction(glGetAttachedShaders, __VA_ARGS__)
#define glGetAttribLocation(...) GLEGetCurrentFunction(glGetAttribLocation, __VA_ARGS__)
#define glGetProgramInfoLog(...) GLEGetCurrentFunction(glGetProgramInfoLog, __VA_ARGS__)
#define glGetProgramiv(...) GLEGetCurrentFunction(glGetProgramiv, __VA_ARGS__)
#define glGetShaderInfoLog(...) GLEGetCurrentFunction(glGetShaderInfoLog, __VA_ARGS__)
#define glGetShaderSource(...) GLEGetCurrentFunction(glGetShaderSource, __VA_ARGS__)
#define glGetShaderiv(...) GLEGetCurrentFunction(glGetShaderiv, __VA_ARGS__)
#define glGetUniformLocation(...) GLEGetCurrentFunction(glGetUniformLocation, __VA_ARGS__)
#define glGetUniformfv(...) GLEGetCurrentFunction(glGetUniformfv, __VA_ARGS__)
#define glGetUniformiv(...) GLEGetCurrentFunction(glGetUniformiv, __VA_ARGS__)
#define glGetVertexAttribPointerv(...) GLEGetCurrentFunction(glGetVertexAttribPointerv, __VA_ARGS__)
#define glGetVertexAttribdv(...) GLEGetCurrentFunction(glGetVertexAttribdv, __VA_ARGS__)
#define glGetVertexAttribfv(...) GLEGetCurrentFunction(glGetVertexAttribfv, __VA_ARGS__)
#define glGetVertexAttribiv(...) GLEGetCurrentFunction(glGetVertexAttribiv, __VA_ARGS__)
#define glIsProgram(...) GLEGetCurrentFunction(glIsProgram, __VA_ARGS__)
#define glIsShader(...) GLEGetCurrentFunction(glIsShader, __VA_ARGS__)
#define glLinkProgram(...) GLEGetCurrentFunction(glLinkProgram, __VA_ARGS__)
#define glShaderSource(...) GLEGetCurrentFunction(glShaderSource, __VA_ARGS__)
#define glStencilFuncSeparate(...) GLEGetCurrentFunction(glStencilFuncSeparate, __VA_ARGS__)
#define glStencilMaskSeparate(...) GLEGetCurrentFunction(glStencilMaskSeparate, __VA_ARGS__)
#define glStencilOpSeparate(...) GLEGetCurrentFunction(glStencilOpSeparate, __VA_ARGS__)
#define glUniform1f(...) GLEGetCurrentFunction(glUniform1f, __VA_ARGS__)
#define glUniform1fv(...) GLEGetCurrentFunction(glUniform1fv, __VA_ARGS__)
#define glUniform1i(...) GLEGetCurrentFunction(glUniform1i, __VA_ARGS__)
#define glUniform1iv(...) GLEGetCurrentFunction(glUniform1iv, __VA_ARGS__)
#define glUniform2f(...) GLEGetCurrentFunction(glUniform2f, __VA_ARGS__)
#define glUniform2fv(...) GLEGetCurrentFunction(glUniform2fv, __VA_ARGS__)
#define glUniform2i(...) GLEGetCurrentFunction(glUniform2i, __VA_ARGS__)
#define glUniform2iv(...) GLEGetCurrentFunction(glUniform2iv, __VA_ARGS__)
#define glUniform3f(...) GLEGetCurrentFunction(glUniform3f, __VA_ARGS__)
#define glUniform3fv(...) GLEGetCurrentFunction(glUniform3fv, __VA_ARGS__)
#define glUniform3i(...) GLEGetCurrentFunction(glUniform3i, __VA_ARGS__)
#define glUniform3iv(...) GLEGetCurrentFunction(glUniform3iv, __VA_ARGS__)
#define glUniform4f(...) GLEGetCurrentFunction(glUniform4f, __VA_ARGS__)
#define glUniform4fv(...) GLEGetCurrentFunction(glUniform4fv, __VA_ARGS__)
#define glUniform4i(...) GLEGetCurrentFunction(glUniform4i, __VA_ARGS__)
#define glUniform4iv(...) GLEGetCurrentFunction(glUniform4iv, __VA_ARGS__)
#define glUniformMatrix2fv(...) GLEGetCurrentFunction(glUniformMatrix2fv, __VA_ARGS__)
#define glUniformMatrix3fv(...) GLEGetCurrentFunction(glUniformMatrix3fv, __VA_ARGS__)
#define glUniformMatrix4fv(...) GLEGetCurrentFunction(glUniformMatrix4fv, __VA_ARGS__)
#define glUseProgram(...) GLEGetCurrentFunction(glUseProgram, __VA_ARGS__)
#define glValidateProgram(...) GLEGetCurrentFunction(glValidateProgram, __VA_ARGS__)
#define glVertexAttrib1d(...) GLEGetCurrentFunction(glVertexAttrib1d, __VA_ARGS__)
#define glVertexAttrib1dv(...) GLEGetCurrentFunction(glVertexAttrib1dv, __VA_ARGS__)
#define glVertexAttrib1f(...) GLEGetCurrentFunction(glVertexAttrib1f, __VA_ARGS__)
#define glVertexAttrib1fv(...) GLEGetCurrentFunction(glVertexAttrib1fv, __VA_ARGS__)
#define glVertexAttrib1s(...) GLEGetCurrentFunction(glVertexAttrib1s, __VA_ARGS__)
#define glVertexAttrib1sv(...) GLEGetCurrentFunction(glVertexAttrib1sv, __VA_ARGS__)
#define glVertexAttrib2d(...) GLEGetCurrentFunction(glVertexAttrib2d, __VA_ARGS__)
#define glVertexAttrib2dv(...) GLEGetCurrentFunction(glVertexAttrib2dv, __VA_ARGS__)
#define glVertexAttrib2f(...) GLEGetCurrentFunction(glVertexAttrib2f, __VA_ARGS__)
#define glVertexAttrib2fv(...) GLEGetCurrentFunction(glVertexAttrib2fv, __VA_ARGS__)
#define glVertexAttrib2s(...) GLEGetCurrentFunction(glVertexAttrib2s, __VA_ARGS__)
#define glVertexAttrib2sv(...) GLEGetCurrentFunction(glVertexAttrib2sv, __VA_ARGS__)
#define glVertexAttrib3d(...) GLEGetCurrentFunction(glVertexAttrib3d, __VA_ARGS__)
#define glVertexAttrib3dv(...) GLEGetCurrentFunction(glVertexAttrib3dv, __VA_ARGS__)
#define glVertexAttrib3f(...) GLEGetCurrentFunction(glVertexAttrib3f, __VA_ARGS__)
#define glVertexAttrib3fv(...) GLEGetCurrentFunction(glVertexAttrib3fv, __VA_ARGS__)
#define glVertexAttrib3s(...) GLEGetCurrentFunction(glVertexAttrib3s, __VA_ARGS__)
#define glVertexAttrib3sv(...) GLEGetCurrentFunction(glVertexAttrib3sv, __VA_ARGS__)
#define glVertexAttrib4Nbv(...) GLEGetCurrentFunction(glVertexAttrib4Nbv, __VA_ARGS__)
#define glVertexAttrib4Niv(...) GLEGetCurrentFunction(glVertexAttrib4Niv, __VA_ARGS__)
#define glVertexAttrib4Nsv(...) GLEGetCurrentFunction(glVertexAttrib4Nsv, __VA_ARGS__)
#define glVertexAttrib4Nub(...) GLEGetCurrentFunction(glVertexAttrib4Nub, __VA_ARGS__)
#define glVertexAttrib4Nubv(...) GLEGetCurrentFunction(glVertexAttrib4Nubv, __VA_ARGS__)
#define glVertexAttrib4Nuiv(...) GLEGetCurrentFunction(glVertexAttrib4Nuiv, __VA_ARGS__)
#define glVertexAttrib4Nusv(...) GLEGetCurrentFunction(glVertexAttrib4Nusv, __VA_ARGS__)
#define glVertexAttrib4bv(...) GLEGetCurrentFunction(glVertexAttrib4bv, __VA_ARGS__)
#define glVertexAttrib4d(...) GLEGetCurrentFunction(glVertexAttrib4d, __VA_ARGS__)
#define glVertexAttrib4dv(...) GLEGetCurrentFunction(glVertexAttrib4dv, __VA_ARGS__)
#define glVertexAttrib4f(...) GLEGetCurrentFunction(glVertexAttrib4f, __VA_ARGS__)
#define glVertexAttrib4fv(...) GLEGetCurrentFunction(glVertexAttrib4fv, __VA_ARGS__)
#define glVertexAttrib4iv(...) GLEGetCurrentFunction(glVertexAttrib4iv, __VA_ARGS__)
#define glVertexAttrib4s(...) GLEGetCurrentFunction(glVertexAttrib4s, __VA_ARGS__)
#define glVertexAttrib4sv(...) GLEGetCurrentFunction(glVertexAttrib4sv, __VA_ARGS__)
#define glVertexAttrib4ubv(...) GLEGetCurrentFunction(glVertexAttrib4ubv, __VA_ARGS__)
#define glVertexAttrib4uiv(...) GLEGetCurrentFunction(glVertexAttrib4uiv, __VA_ARGS__)
#define glVertexAttrib4usv(...) GLEGetCurrentFunction(glVertexAttrib4usv, __VA_ARGS__)
#define glVertexAttribPointer(...) GLEGetCurrentFunction(glVertexAttribPointer, __VA_ARGS__)
...
#define glUniformMatrix2x3fv(...) GLEGetCurrentFunction(glUniformMatrix2x3fv, __VA_ARGS__)
#define glUniformMatrix2x4fv(...) GLEGetCurrentFunction(glUniformMatrix2x4fv, __VA_ARGS__)
#define glUniformMatrix3x2fv(...) GLEGetCurrentFunction(glUniformMatrix3x2fv, __VA_ARGS__)
#define glUniformMatrix3x4fv(...) GLEGetCurrentFunction(glUniformMatrix3x4fv, __VA_ARGS__)
#define glUniformMatrix4x2fv(...) GLEGetCurrentFunction(glUniformMatrix4x2fv, __VA_ARGS__)
#define glUniformMatrix4x3fv(...) GLEGetCurrentFunction(glUniformMatrix4x3fv, __VA_ARGS__)
...
#define glBeginConditionalRender(...) GLEGetCurrentFunction(glBeginConditionalRender, __VA_ARGS__)
#define glBeginTransformFeedback(...) GLEGetCurrentFunction(glBeginTransformFeedback, __VA_ARGS__)
#define glBindFragDataLocation(...) GLEGetCurrentFunction(glBindFragDataLocation, __VA_ARGS__)
#define glClampColor(...) GLEGetCurrentFunction(glClampColor, __VA_ARGS__)
#define glClearBufferfi(...) GLEGetCurrentFunction(glClearBufferfi, __VA_ARGS__)
#define glClearBufferfv(...) GLEGetCurrentFunction(glClearBufferfv, __VA_ARGS__)
#define glClearBufferiv(...) GLEGetCurrentFunction(glClearBufferiv, __VA_ARGS__)
#define glClearBufferuiv(...) GLEGetCurrentFunction(glClearBufferuiv, __VA_ARGS__)
#define glColorMaski(...) GLEGetCurrentFunction(glColorMaski, __VA_ARGS__)
#define glDisablei(...) GLEGetCurrentFunction(glDisablei, __VA_ARGS__)
#define glEnablei(...) GLEGetCurrentFunction(glEnablei, __VA_ARGS__)
#define glEndConditionalRender(...) GLEGetCurrentFunction(glEndConditionalRender, __VA_ARGS__)
#define glEndTransformFeedback(...) GLEGetCurrentFunction(glEndTransformFeedback, __VA_ARGS__)
#define glGetBooleani_v(...) GLEGetCurrentFunction(glGetBooleani_v, __VA_ARGS__)
#define glGetIntegeri_v(...) GLEGetCurrentFunction(glGetIntegeri_v, __VA_ARGS__)
#define glGetFragDataLocation(...) GLEGetCurrentFunction(glGetFragDataLocation, __VA_ARGS__)
#define glGetStringi(...) GLEGetCurrentFunction(glGetStringi, __VA_ARGS__)
#define glGetTexParameterIiv(...) GLEGetCurrentFunction(glGetTexParameterIiv, __VA_ARGS__)
#define glGetTexParameterIuiv(...) GLEGetCurrentFunction(glGetTexParameterIuiv, __VA_ARGS__)
#define glGetTransformFeedbackVarying(...) GLEGetCurrentFunction(glGetTransformFeedbackVarying, __VA_ARGS__)
#define glGetUniformuiv(...) GLEGetCurrentFunction(glGetUniformuiv, __VA_ARGS__)
#define glGetVertexAttribIiv(...) GLEGetCurrentFunction(glGetVertexAttribIiv, __VA_ARGS__)
#define glGetVertexAttribIuiv(...) GLEGetCurrentFunction(glGetVertexAttribIuiv, __VA_ARGS__)
#define glIsEnabledi(...) GLEGetCurrentFunction(glIsEnabledi, __VA_ARGS__)
#define glTexParameterIiv(...) GLEGetCurrentFunction(glTexParameterIiv, __VA_ARGS__)
#define glTexParameterIuiv(...) GLEGetCurrentFunction(glTexParameterIuiv, __VA_ARGS__)
#define glTransformFeedbackVaryings(...) GLEGetCurrentFunction(glTransformFeedbackVaryings, __VA_ARGS__)
#define glUniform1ui(...) GLEGetCurrentFunction(glUniform1ui, __VA_ARGS__)
#define glUniform1uiv(...) GLEGetCurrentFunction(glUniform1uiv, __VA_ARGS__)
#define glUniform2ui(...) GLEGetCurrentFunction(glUniform2ui, __VA_ARGS__)
#define glUniform2uiv(...) GLEGetCurrentFunction(glUniform2uiv, __VA_ARGS__)
#define glUniform3ui(...) GLEGetCurrentFunction(glUniform3ui, __VA_ARGS__)
#define glUniform3uiv(...) GLEGetCurrentFunction(glUniform3uiv, __VA_ARGS__)
#define glUniform4ui(...) GLEGetCurrentFunction(glUniform4ui, __VA_ARGS__)
#define glUniform4uiv(...) GLEGetCurrentFunction(glUniform4uiv, __VA_ARGS__)
#define glVertexAttribI1i(...) GLEGetCurrentFunction(glVertexAttribI1i, __VA_ARGS__)
#define glVertexAttribI1iv(...) GLEGetCurrentFunction(glVertexAttribI1iv, __VA_ARGS__)
#define glVertexAttribI1ui(...) GLEGetCurrentFunction(glVertexAttribI1ui, __VA_ARGS__)
#define glVertexAttribI1uiv(...) GLEGetCurrentFunction(glVertexAttribI1uiv, __VA_ARGS__)
#define glVertexAttribI2i(...) GLEGetCurrentFunction(glVertexAttribI2i, __VA_ARGS__)
#define glVertexAttribI2iv(...) GLEGetCurrentFunction(glVertexAttribI2iv, __VA_ARGS__)
#define glVertexAttribI2ui(...) GLEGetCurrentFunction(glVertexAttribI2ui, __VA_ARGS__)
#define glVertexAttribI2uiv(...) GLEGetCurrentFunction(glVertexAttribI2uiv, __VA_ARGS__)
#define glVertexAttribI3i(...) GLEGetCurrentFunction(glVertexAttribI3i, __VA_ARGS__)
#define glVertexAttribI3iv(...) GLEGetCurrentFunction(glVertexAttribI3iv, __VA_ARGS__)
#define glVertexAttribI3ui(...) GLEGetCurrentFunction(glVertexAttribI3ui, __VA_ARGS__)
#define glVertexAttribI3uiv(...) GLEGetCurrentFunction(glVertexAttribI3uiv, __VA_ARGS__)
#define glVertexAttribI4bv(...) GLEGetCurrentFunction(glVertexAttribI4bv, __VA_ARGS__)
#define glVertexAttribI4i(...) GLEGetCurrentFunction(glVertexAttribI4i, __VA_ARGS__)
#define glVertexAttribI4iv(...) GLEGetCurrentFunction(glVertexAttribI4iv, __VA_ARGS__)
#define glVertexAttribI4sv(...) GLEGetCurrentFunction(glVertexAttribI4sv, __VA_ARGS__)
#define glVertexAttribI4ubv(...) GLEGetCurrentFunction(glVertexAttribI4ubv, __VA_ARGS__)
#define glVertexAttribI4ui(...) GLEGetCurrentFunction(glVertexAttribI4ui, __VA_ARGS__)
#define glVertexAttribI4uiv(...) GLEGetCurrentFunction(glVertexAttribI4uiv, __VA_ARGS__)
#define glVertexAttribI4usv(...) GLEGetCurrentFunction(glVertexAttribI4usv, __VA_ARGS__)
#define glVertexAttribIPointer(...) GLEGetCurrentFunction(glVertexAttribIPointer, __VA_ARGS__)
...
#define glDrawArraysInstanced(...) GLEGetCurrentFunction(glDrawArraysInstanced, __VA_ARGS__)
#define glDrawElementsInstanced(...) GLEGetCurrentFunction(glDrawElementsInstanced, __VA_ARGS__)
#define glPrimitiveRestartIndex(...) GLEGetCurrentFunction(glPrimitiveRestartIndex, __VA_ARGS__)
#define glTexBuffer(...) GLEGetCurrentFunction(glTexBuffer, __VA_ARGS__)
...
#define glFramebufferTexture(...) GLEGetCurrentFunction(glFramebufferTexture, __VA_ARGS__)
#define glGetBufferParameteri64v(...) GLEGetCurrentFunction(glGetBufferParameteri64v, __VA_ARGS__)
#define glGetInteger64i_v(...) GLEGetCurrentFunction(glGetInteger64i_v, __VA_ARGS__)
...
#define glVertexAttribDivisor(...) GLEGetCurrentFunction(glVertexAttribDivisor, __VA_ARGS__)
#endif
...
#define glBlendEquationSeparatei(...) GLEGetCurrentFunction(glBlendEquationSeparatei, __VA_ARGS__)
#define glBlendEquationi(...) GLEGetCurrentFunction(glBlendEquationi, __VA_ARGS__)
#define glBlendFuncSeparatei(...) GLEGetCurrentFunction(glBlendFuncSeparatei, __VA_ARGS__)
#define glBlendFunci(...) GLEGetCurrentFunction(glBlendFunci, __VA_ARGS__)
#define glMinSampleShading(...) GLEGetCurrentFunction(glMinSampleShading, __VA_ARGS__)
...
#define glMemoryBarrier(...) GLEGetCurrentFunction(glMemoryBarrier, __VA_ARGS__)
...
#define glDispatchCompute(...) GLEGetCurrentFunction(glDispatchCompute, __VA_ARGS__)
#define glBindImageTexture(...) GLEGetCurrentFunction(glBindImageTexture, __VA_ARGS__);
...
#define glDebugMessageCallbackAMD(...) GLEGetCurrentFunction(glDebugMessageCallbackAMD, __VA_ARGS__)
#define glDebugMessageEnableAMD(...) GLEGetCurrentFunction(glDebugMessageEnableAMD, __VA_ARGS__)
#define glDebugMessageInsertAMD(...) GLEGetCurrentFunction(glDebugMessageInsertAMD, __VA_ARGS__)
#define glGetDebugMessageLogAMD(...) GLEGetCurrentFunction(glGetDebugMessageLogAMD, __VA_ARGS__)
...
enable, GLuint group, GLint numCounters, GLuint* counterList);
    ...
    #define glBeginPerfMonitorAMD(...) GLEGetCurrentFunction(glBeginPerfMonitorAMD, __VA_ARGS__)
    #define glDeletePerfMonitorsAMD(...) GLEGetCurrentFunction(glDeletePerfMonitorsAMD, __VA_ARGS__)
    #define glEndPerfMonitorAMD(...) GLEGetCurrentFunction(glEndPerfMonitorAMD, __VA_ARGS__)
    #define glGenPerfMonitorsAMD(...) GLEGetCurrentFunction(glGenPerfMonitorsAMD, __VA_ARGS__)
    #define glGetPerfMonitorCounterDataAMD(...) GLEGetCurrentFunction(glGetPerfMonitorCounterDataAMD, __VA_ARGS__)
    #define glGetPerfMonitorCounterInfoAMD(...) GLEGetCurrentFunction(glGetPerfMonitorCounterInfoAMD, __VA_ARGS__)
    #define glGetPerfMonitorCounterStringAMD(...) GLEGetCurrentFunction(glGetPerfMonitorCounterStringAMD, __VA_ARGS__)
    #define glGetPerfMonitorCountersAMD(...) GLEGetCurrentFunction(glGetPerfMonitorCountersAMD, __VA_ARGS__)
    #define glGetPerfMonitorGroupStringAMD(...) GLEGetCurrentFunction(glGetPerfMonitorGroupStringAMD, __VA_ARGS__)
    #define glGetPerfMonitorGroupsAMD(...) GLEGetCurrentFunction(glGetPerfMonitorGroupsAMD, __VA_ARGS__)
    #define glSelectPerfMonitorCountersAMD(...) GLEGetCurrentFunction(glSelectPerfMonitorCountersAMD, __VA_ARGS__)
...
#define glDrawElementArrayAPPLE(...) GLEGetCurrentFunction(glDrawElementArrayAPPLE, __VA_ARGS__)
#define glDrawRangeElementArrayAPPLE(...) GLEGetCurrentFunction(glDrawRangeElementArrayAPPLE, __VA_ARGS__)
#define glElementPointerAPPLE(...) GLEGetCurrentFunction(glElementPointerAPPLE, __VA_ARGS__)
#define glMultiDrawElementArrayAPPLE(...) GLEGetCurrentFunction(glMultiDrawElementArrayAPPLE, __VA_ARGS__)
#define glMultiDrawRangeElementArrayAPPLE(...) GLEGetCurrentFunction(glMultiDrawRangeElementArrayAPPLE, __VA_ARGS__)
...
#define glDeleteFencesAPPLE(...) GLEGetCurrentFunction(glDeleteFencesAPPLE, __VA_ARGS__)
#define glFinishFenceAPPLE(...) GLEGetCurrentFunction(glFinishFenceAPPLE, __VA_ARGS__)
#define glFinishObjectAPPLE(...) GLEGetCurrentFunction(glFinishObjectAPPLE, __VA_ARGS__)
#define glGenFencesAPPLE(...) GLEGetCurrentFunction(glGenFencesAPPLE, __VA_ARGS__)
#define glIsFenceAPPLE(...) GLEGetCurrentFunction(glIsFenceAPPLE, __VA_ARGS__)
#define glSetFenceAPPLE(...) GLEGetCurrentFunction(glSetFenceAPPLE, __VA_ARGS__)
#define glTestFenceAPPLE(...) GLEGetCurrentFunction(glTestFenceAPPLE, __VA_ARGS__)
#define glTestObjectAPPLE(...) GLEGetCurrentFunction(glTestObjectAPPLE, __VA_ARGS__)
...
#define glBufferParameteriAPPLE(...) GLEGetCurrentFunction(glBufferParameteriAPPLE, __VA_ARGS__)
#define glFlushMappedBufferRangeAPPLE(...) GLEGetCurrentFunction(glFlushMappedBufferRangeAPPLE, __VA_ARGS__)
...
#define glGetObjectParameterivAPPLE(...) GLEGetCurrentFunction(glGetObjectParameterivAPPLE, __VA_ARGS__)
#define glObjectPurgeableAPPLE(...) GLEGetCurrentFunction(glObjectPurgeableAPPLE, __VA_ARGS__)
#define glObjectUnpurgeableAPPLE(...) GLEGetCurrentFunction(glObjectUnpurgeableAPPLE, __VA_ARGS__)
...
#define glGetTexParameterPointervAPPLE(...) GLEGetCurrentFunction(glGetTexParameterPointervAPPLE, __VA_ARGS__)
#define glTextureRangeAPPLE(...) GLEGetCurrentFunction(glTextureRangeAPPLE, __VA_ARGS__)
...
#define glBindVertexArrayAPPLE(...) GLEGetCurrentFunction(glBindVertexArrayAPPLE, __VA_ARGS__)
#define glDeleteVertexArraysAPPLE(...) GLEGetCurrentFunction(glDeleteVertexArraysAPPLE, __VA_ARGS__)
#define glGenVertexArraysAPPLE(...) GLEGetCurrentFunction(glGenVertexArraysAPPLE, __VA_ARGS__)
#define glIsVertexArrayAPPLE(...) GLEGetCurrentFunction(glIsVertexArrayAPPLE, __VA_ARGS__)
...
#define glFlushVertexArrayRangeAPPLE(...) GLEGetCurrentFunction(glFlushVertexArrayRangeAPPLE, __VA_ARGS__)
#define glVertexArrayParameteriAPPLE(...) GLEGetCurrentFunction(glVertexArrayParameteriAPPLE, __VA_ARGS__)
#define glVertexArrayRangeAPPLE(...) GLEGetCurrentFunction(glVertexArrayRangeAPPLE, __VA_ARGS__)
...
#define glDisableVertexAttribAPPLE(...) GLEGetCurrentFunction(glDisableVertexAttribAPPLE, __VA_ARGS__)
#define glEnableVertexAttribAPPLE(...) GLEGetCurrentFunction(glEnableVertexAttribAPPLE, __VA_ARGS__)
#define glIsVertexAttribEnabledAPPLE(...) GLEGetCurrentFunction(glIsVertexAttribEnabledAPPLE, __VA_ARGS__)
#define glMapVertexAttrib1dAPPLE(...) GLEGetCurrentFunction(glMapVertexAttrib1dAPPLE, __VA_ARGS__)
#define glMapVertexAttrib1fAPPLE(...) GLEGetCurrentFunction(glMapVertexAttrib1fAPPLE, __VA_ARGS__)
#define glMapVertexAttrib2dAPPLE(...) GLEGetCurrentFunction(glMapVertexAttrib2dAPPLE, __VA_ARGS__)
#define glMapVertexAttrib2fAPPLE(...) GLEGetCurrentFunction(glMapVertexAttrib2fAPPLE, __VA_ARGS__)
...
#define glCopyBufferSubData(...) GLEGetCurrentFunction(glCopyBufferSubData, __VA_ARGS__)
...
#define glDebugMessageCallbackARB(...) GLEGetCurrentFunction(glDebugMessageCallbackARB, __VA_ARGS__)
#define glDebugMessageControlARB(...) GLEGetCurrentFunction(glDebugMessageControlARB, __VA_ARGS__)
#define glDebugMessageInsertARB(...) GLEGetCurrentFunction(glDebugMessageInsertARB, __VA_ARGS__)
#define glGetDebugMessageLogARB(...) GLEGetCurrentFunction(glGetDebugMessageLogARB, __VA_ARGS__)
...
GLsizei count, const GLuint* buffers, const GLintptr *offsets, const GLsizei *strides);
    ...
    #define glBindTextureUnit(...) GLEGetCurrentFunction(glBindTextureUnit, __VA_ARGS__)
    #define glBlitNamedFramebuffer(...) GLEGetCurrentFunction(glBlitNamedFramebuffer, __VA_ARGS__)
    #define glCheckNamedFramebufferStatus(...) GLEGetCurrentFunction(glCheckNamedFramebufferStatus, __VA_ARGS__)
    #define glClearNamedBufferData(...) GLEGetCurrentFunction(glClearNamedBufferData, __VA_ARGS__)
    #define glClearNamedBufferSubData(...) GLEGetCurrentFunction(glClearNamedBufferSubData, __VA_ARGS__)
    #define glClearNamedFramebufferfi(...) GLEGetCurrentFunction(glClearNamedFramebufferfi, __VA_ARGS__)
    #define glClearNamedFramebufferfv(...) GLEGetCurrentFunction(glClearNamedFramebufferfv, __VA_ARGS__)
    #define glClearNamedFramebufferiv(...) GLEGetCurrentFunction(glClearNamedFramebufferiv, __VA_ARGS__)
    #define glClearNamedFramebufferuiv(...) GLEGetCurrentFunction(glClearNamedFramebufferuiv, __VA_ARGS__)
    #define glCompressedTextureSubImage1D(...) GLEGetCurrentFunction(glCompressedTextureSubImage1D, __VA_ARGS__)
    #define glCompressedTextureSubImage2D(...) GLEGetCurrentFunction(glCompressedTextureSubImage2D, __VA_ARGS__)
    #define glCompressedTextureSubImage3D(...) GLEGetCurrentFunction(glCompressedTextureSubImage3D, __VA_ARGS__)
    #define glCopyNamedBufferSubData(...) GLEGetCurrentFunction(glCopyNamedBufferSubData, __VA_ARGS__)
    #define glCopyTextureSubImage1D(...) GLEGetCurrentFunction(glCopyTextureSubImage1D, __VA_ARGS__)
    #define glCopyTextureSubImage2D(...) GLEGetCurrentFunction(glCopyTextureSubImage2D, __VA_ARGS__)
    #define glCopyTextureSubImage3D(...) GLEGetCurrentFunction(glCopyTextureSubImage3D, __VA_ARGS__)
    #define glCreateBuffers(...) GLEGetCurrentFunction(glCreateBuffers, __VA_ARGS__)
    #define glCreateFramebuffers(...) GLEGetCurrentFunction(glCreateFramebuffers, __VA_ARGS__)
    #define glCreateProgramPipelines(...) GLEGetCurrentFunction(glCreateProgramPipelines, __VA_ARGS__)
    #define glCreateQueries(...) GLEGetCurrentFunction(glCreateQueries, __VA_ARGS__)
    #define glCreateRenderbuffers(...) GLEGetCurrentFunction(glCreateRenderbuffers, __VA_ARGS__)
    #define glCreateSamplers(...) GLEGetCurrentFunction(glCreateSamplers, __VA_ARGS__)
    #define glCreateTextures(...) GLEGetCurrentFunction(glCreateTextures, __VA_ARGS__)
    #define glCreateTransformFeedbacks(...) GLEGetCurrentFunction(glCreateTransformFeedbacks, __VA_ARGS__)
    #define glCreateVertexArrays(...) GLEGetCurrentFunction(glCreateVertexArrays, __VA_ARGS__)
    #define glDisableVertexArrayAttrib(...) GLEGetCurrentFunction(glDisableVertexArrayAttrib, __VA_ARGS__)
    #define glEnableVertexArrayAttrib(...) GLEGetCurrentFunction(glEnableVertexArrayAttrib, __VA_ARGS__)
    #define glFlushMappedNamedBufferRange(...) GLEGetCurrentFunction(glFlushMappedNamedBufferRange, __VA_ARGS__)
    #define glGenerateTextureMipmap(...) GLEGetCurrentFunction(glGenerateTextureMipmap, __VA_ARGS__)
    #define glGetCompressedTextureImage(...) GLEGetCurrentFunction(glGetCompressedTextureImage, __VA_ARGS__)
    #define glGetNamedBufferParameteri64v(...) GLEGetCurrentFunction(glGetNamedBufferParameteri64v, __VA_ARGS__)
    #define glGetNamedBufferParameteriv(...) GLEGetCurrentFunction(glGetNamedBufferParameteriv, __VA_ARGS__)
    #define glGetNamedBufferPointerv(...) GLEGetCurrentFunction(glGetNamedBufferPointerv, __VA_ARGS__)
    #define glGetNamedBufferSubData(...) GLEGetCurrentFunction(glGetNamedBufferSubData, __VA_ARGS__)
    #define glGetNamedFramebufferAttachmentParameteriv
GLEGetCurrentFunction(glGetNamedFramebufferAttachmentParameteriv)
    #define glGetNamedFramebufferParameteriv(...) GLEGetCurrentFunction(glGetNamedFramebufferParameteriv, __VA_ARGS__)
    #define glGetNamedRenderbufferParameteriv
GLEGetCurrentFunction(glGetNamedRenderbufferParameteriv)
    #define glGetTextureImage(...) GLEGetCurrentFunction(glGetTextureImage, __VA_ARGS__)
    #define glGetTextureLevelParameterfv(...) GLEGetCurrentFunction(glGetTextureLevelParameterfv, __VA_ARGS__)
    #define glGetTextureLevelParameteriv(...) GLEGetCurrentFunction(glGetTextureLevelParameteriv, __VA_ARGS__)
    #define glGetTextureParameterIiv(...) GLEGetCurrentFunction(glGetTextureParameterIiv, __VA_ARGS__)
    #define glGetTextureParameterIuiv(...) GLEGetCurrentFunction(glGetTextureParameterIuiv, __VA_ARGS__)
    #define glGetTextureParameterfv(...) GLEGetCurrentFunction(glGetTextureParameterfv, __VA_ARGS__)
    #define glGetTextureParameteriv(...) GLEGetCurrentFunction(glGetTextureParameteriv, __VA_ARGS__)
    #define glGetTransformFeedbacki64_v(...) GLEGetCurrentFunction(glGetTransformFeedbacki64_v, __VA_ARGS__)
    #define glGetTransformFeedbacki_v(...) GLEGetCurrentFunction(glGetTransformFeedbacki_v, __VA_ARGS__)
    #define glGetTransformFeedbackiv(...) GLEGetCurrentFunction(glGetTransformFeedbackiv, __VA_ARGS__)
    #define glGetVertexArrayIndexed64iv(...) GLEGetCurrentFunction(glGetVertexArrayIndexed64iv, __VA_ARGS__)
    #define glGetVertexArrayIndexediv(...) GLEGetCurrentFunction(glGetVertexArrayIndexediv, __VA_ARGS__)
    #define glGetVertexArrayiv(...) GLEGetCurrentFunction(glGetVertexArrayiv, __VA_ARGS__)
    #define glInvalidateNamedFramebufferData(...) GLEGetCurrentFunction(glInvalidateNamedFramebufferData, __VA_ARGS__)
    #define glInvalidateNamedFramebufferSubData
GLEGetCurrentFunction(glInvalidateNamedFramebufferSubData)
    #define glMapNamedBuffer(...) GLEGetCurrentFunction(glMapNamedBuffer, __VA_ARGS__)
    #define glMapNamedBufferRange(...) GLEGetCurrentFunction(glMapNamedBufferRange, __VA_ARGS__)
    #define glNamedBufferData(...) GLEGetCurrentFunction(glNamedBufferData, __VA_ARGS__)
    #define glNamedBufferStorage(...) GLEGetCurrentFunction(glNamedBufferStorage, __VA_ARGS__)
    #define glNamedBufferSubData(...) GLEGetCurrentFunction(glNamedBufferSubData, __VA_ARGS__)
    #define glNamedFramebufferDrawBuffer(...) GLEGetCurrentFunction(glNamedFramebufferDrawBuffer, __VA_ARGS__)
    #define glNamedFramebufferDrawBuffers(...) GLEGetCurrentFunction(glNamedFramebufferDrawBuffers, __VA_ARGS__)
    #define glNamedFramebufferParameteri(...) GLEGetCurrentFunction(glNamedFramebufferParameteri, __VA_ARGS__)
    #define glNamedFramebufferReadBuffer(...) GLEGetCurrentFunction(glNamedFramebufferReadBuffer, __VA_ARGS__)
    #define glNamedFramebufferRenderbuffer(...) GLEGetCurrentFunction(glNamedFramebufferRenderbuffer, __VA_ARGS__)
    #define glNamedFramebufferTexture(...) GLEGetCurrentFunction(glNamedFramebufferTexture, __VA_ARGS__)
    #define glNamedFramebufferTextureLayer(...) GLEGetCurrentFunction(glNamedFramebufferTextureLayer, __VA_ARGS__)
    #define glNamedRenderbufferStorage(...) GLEGetCurrentFunction(glNamedRenderbufferStorage, __VA_ARGS__)
    #define glNamedRenderbufferStorageMultisample
GLEGetCurrentFunction(glNamedRenderbufferStorageMultisample)
    #define glTextureBuffer(...) GLEGetCurrentFunction(glTextureBuffer, __VA_ARGS__)
    #define glTextureBufferRange(...) GLEGetCurrentFunction(glTextureBufferRange, __VA_ARGS__)
    #define glTextureParameterIiv(...) GLEGetCurrentFunction(glTextureParameterIiv, __VA_ARGS__)
    #define glTextureParameterIuiv(...) GLEGetCurrentFunction(glTextureParameterIuiv, __VA_ARGS__)
    #define glTextureParameterf(...) GLEGetCurrentFunction(glTextureParameterf, __VA_ARGS__)
    #define glTextureParameterfv(...) GLEGetCurrentFunction(glTextureParameterfv, __VA_ARGS__)
    #define glTextureParameteri(...) GLEGetCurrentFunction(glTextureParameteri, __VA_ARGS__)
    #define glTextureParameteriv(...) GLEGetCurrentFunction(glTextureParameteriv, __VA_ARGS__)
    #define glTextureStorage1D(...) GLEGetCurrentFunction(glTextureStorage1D, __VA_ARGS__)
    #define glTextureStorage2D(...) GLEGetCurrentFunction(glTextureStorage2D, __VA_ARGS__)
    #define glTextureStorage2DMultisample(...) GLEGetCurrentFunction(glTextureStorage2DMultisample, __VA_ARGS__)
    #define glTextureStorage3D(...) GLEGetCurrentFunction(glTextureStorage3D, __VA_ARGS__)
    #define glTextureStorage3DMultisample(...) GLEGetCurrentFunction(glTextureStorage3DMultisample, __VA_ARGS__)
    #define glTextureSubImage1D(...) GLEGetCurrentFunction(glTextureSubImage1D, __VA_ARGS__)
    #define glTextureSubImage2D(...) GLEGetCurrentFunction(glTextureSubImage2D, __VA_ARGS__)
    #define glTextureSubImage3D(...) GLEGetCurrentFunction(glTextureSubImage3D, __VA_ARGS__)
    #define glTransformFeedbackBufferBase(...) GLEGetCurrentFunction(glTransformFeedbackBufferBase, __VA_ARGS__)
    #define glTransformFeedbackBufferRange(...) GLEGetCurrentFunction(glTransformFeedbackBufferRange, __VA_ARGS__)
    #define glUnmapNamedBuffer(...) GLEGetCurrentFunction(glUnmapNamedBuffer, __VA_ARGS__)
    #define glVertexArrayAttribBinding(...) GLEGetCurrentFunction(glVertexArrayAttribBinding, __VA_ARGS__)
    #define glVertexArrayAttribFormat(...) GLEGetCurrentFunction(glVertexArrayAttribFormat, __VA_ARGS__)
    #define glVertexArrayAttribIFormat(...) GLEGetCurrentFunction(glVertexArrayAttribIFormat, __VA_ARGS__)
    #define glVertexArrayAttribLFormat(...) GLEGetCurrentFunction(glVertexArrayAttribLFormat, __VA_ARGS__)
    #define glVertexArrayBindingDivisor(...) GLEGetCurrentFunction(glVertexArrayBindingDivisor, __VA_ARGS__)
    #define glVertexArrayElementBuffer(...) GLEGetCurrentFunction(glVertexArrayElementBuffer, __VA_ARGS__)
    #define glVertexArrayVertexBuffer(...) GLEGetCurrentFunction(glVertexArrayVertexBuffer, __VA_ARGS__)
    #define glVertexArrayVertexBuffers(...) GLEGetCurrentFunction(glVertexArrayVertexBuffers, __VA_ARGS__)
...
#define glClearDepthf(...) GLEGetCurrentFunction(glClearDepthf, __VA_ARGS__)
#define glDepthRangef(...) GLEGetCurrentFunction(glDepthRangef, __VA_ARGS__)
#define glGetShaderPrecisionFormat(...) GLEGetCurrentFunction(glGetShaderPrecisionFormat, __VA_ARGS__)
#define glReleaseShaderCompiler(...) GLEGetCurrentFunction(glReleaseShaderCompiler, __VA_ARGS__)
#define glShaderBinary(...) GLEGetCurrentFunction(glShaderBinary, __VA_ARGS__)
...
#define glBindFramebuffer(...) GLEGetCurrentFunction(glBindFramebuffer, __VA_ARGS__)
#define glBindRenderbuffer(...) GLEGetCurrentFunction(glBindRenderbuffer, __VA_ARGS__)
#define glBlitFramebuffer(...) GLEGetCurrentFunction(glBlitFramebuffer, __VA_ARGS__)
#define glCheckFramebufferStatus(...) GLEGetCurrentFunction(glCheckFramebufferStatus, __VA_ARGS__)
#define glDeleteFramebuffers(...) GLEGetCurrentFunction(glDeleteFramebuffers, __VA_ARGS__)
#define glDeleteRenderbuffers(...) GLEGetCurrentFunction(glDeleteRenderbuffers, __VA_ARGS__)
#define glFramebufferRenderbuffer(...) GLEGetCurrentFunction(glFramebufferRenderbuffer, __VA_ARGS__)
#define glFramebufferTexture1D(...) GLEGetCurrentFunction(glFramebufferTexture1D, __VA_ARGS__)
#define glFramebufferTexture2D(...) GLEGetCurrentFunction(glFramebufferTexture2D, __VA_ARGS__)
#define glFramebufferTexture3D(...) GLEGetCurrentFunction(glFramebufferTexture3D, __VA_ARGS__)
#define glFramebufferTextureLayer(...) GLEGetCurrentFunction(glFramebufferTextureLayer, __VA_ARGS__)
#define glGenFramebuffers(...) GLEGetCurrentFunction(glGenFramebuffers, __VA_ARGS__)
#define glGenRenderbuffers(...) GLEGetCurrentFunction(glGenRenderbuffers, __VA_ARGS__)
#define glGenerateMipmap(...) GLEGetCurrentFunction(glGenerateMipmap, __VA_ARGS__)
#define glGetFramebufferAttachmentParameteriv \
  GLEGetCurrentFunction(glGetFramebufferAttachmentParameteriv)
#define glGetRenderbufferParameteriv(...) GLEGetCurrentFunction(glGetRenderbufferParameteriv, __VA_ARGS__)
#define glIsFramebuffer(...) GLEGetCurrentFunction(glIsFramebuffer, __VA_ARGS__)
#define glIsRenderbuffer(...) GLEGetCurrentFunction(glIsRenderbuffer, __VA_ARGS__)
#define glRenderbufferStorage(...) GLEGetCurrentFunction(glRenderbufferStorage, __VA_ARGS__)
#define glRenderbufferStorageMultisample(...) GLEGetCurrentFunction(glRenderbufferStorageMultisample, __VA_ARGS__)
...
#define glGetMultisamplefv(...) GLEGetCurrentFunction(glGetMultisamplefv, __VA_ARGS__)
#define glSampleMaski(...) GLEGetCurrentFunction(glSampleMaski, __VA_ARGS__)
#define glTexImage2DMultisample(...) GLEGetCurrentFunction(glTexImage2DMultisample, __VA_ARGS__)
#define glTexImage3DMultisample(...) GLEGetCurrentFunction(glTexImage3DMultisample, __VA_ARGS__)
...
#define glTexStorage1D(...) GLEGetCurrentFunction(glTexStorage1D, __VA_ARGS__)
#define glTexStorage2D(...) GLEGetCurrentFunction(glTexStorage2D, __VA_ARGS__)
#define glTexStorage3D(...) GLEGetCurrentFunction(glTexStorage3D, __VA_ARGS__)
#define glTextureStorage1DEXT(...) GLEGetCurrentFunction(glTextureStorage1DEXT, __VA_ARGS__)
#define glTextureStorage2DEXT(...) GLEGetCurrentFunction(glTextureStorage2DEXT, __VA_ARGS__)
#define glTextureStorage3DEXT(...) GLEGetCurrentFunction(glTextureStorage3DEXT, __VA_ARGS__)
...
#define glTexStorage2DMultisample(...) GLEGetCurrentFunction(glTexStorage2DMultisample, __VA_ARGS__)
#define glTexStorage3DMultisample(...) GLEGetCurrentFunction(glTexStorage3DMultisample, __VA_ARGS__)
#define glTextureStorage2DMultisampleEXT(...) GLEGetCurrentFunction(glTextureStorage2DMultisampleEXT, __VA_ARGS__)
#define glTextureStorage3DMultisampleEXT(...) GLEGetCurrentFunction(glTextureStorage3DMultisampleEXT, __VA_ARGS__)
...
#define glGetQueryObjecti64v(...) GLEGetCurrentFunction(glGetQueryObjecti64v, __VA_ARGS__)
#define glGetQueryObjectui64v(...) GLEGetCurrentFunction(glGetQueryObjectui64v, __VA_ARGS__)
#define glQueryCounter(...) GLEGetCurrentFunction(glQueryCounter, __VA_ARGS__)
...
#define glBindVertexArray(...) GLEGetCurrentFunction(glBindVertexArray, __VA_ARGS__)
#define glDeleteVertexArrays(...) GLEGetCurrentFunction(glDeleteVertexArrays, __VA_ARGS__)
#define glGenVertexArrays(...) GLEGetCurrentFunction(glGenVertexArrays, __VA_ARGS__)
#define glIsVertexArray(...) GLEGetCurrentFunction(glIsVertexArray, __VA_ARGS__)
...
type, GLuint relativeoffset);
    ...
    #define glBindVertexBuffer(...) GLEGetCurrentFunction(glBindVertexBuffer, __VA_ARGS__)
    #define glVertexArrayBindVertexBufferEXT(...) GLEGetCurrentFunction(glVertexArrayBindVertexBufferEXT, __VA_ARGS__)
...
GLEGetCurrentFunction(glVertexArrayVertexBindingDivisorEXT)
    #define glVertexAttribBinding(...) GLEGetCurrentFunction(glVertexAttribBinding, __VA_ARGS__)
    #define glVertexAttribFormat(...) GLEGetCurrentFunction(glVertexAttribFormat, __VA_ARGS__)
    #define glVertexAttribIFormat(...) GLEGetCurrentFunction(glVertexAttribIFormat, __VA_ARGS__)
    #define glVertexAttribLFormat(...) GLEGetCurrentFunction(glVertexAttribLFormat, __VA_ARGS__)
    #define glVertexBindingDivisor(...) GLEGetCurrentFunction(glVertexBindingDivisor, __VA_ARGS__)
...
#define glColorMaskIndexedEXT(...) GLEGetCurrentFunction(glColorMaskIndexedEXT, __VA_ARGS__)
#define glDisableIndexedEXT(...) GLEGetCurrentFunction(glDisableIndexedEXT, __VA_ARGS__)
#define glEnableIndexedEXT(...) GLEGetCurrentFunction(glEnableIndexedEXT, __VA_ARGS__)
#define glGetBooleanIndexedvEXT(...) GLEGetCurrentFunction(glGetBooleanIndexedvEXT, __VA_ARGS__)
#define glGetIntegerIndexedvEXT(...) GLEGetCurrentFunction(glGetIntegerIndexedvEXT, __VA_ARGS__)
#define glIsEnabledIndexedEXT(...) GLEGetCurrentFunction(glIsEnabledIndexedEXT, __VA_ARGS__)
...
#define glDebugMessageCallback(...) GLEGetCurrentFunction(glDebugMessageCallback, __VA_ARGS__)
#define glDebugMessageControl(...) GLEGetCurrentFunction(glDebugMessageControl, __VA_ARGS__)
#define glDebugMessageInsert(...) GLEGetCurrentFunction(glDebugMessageInsert, __VA_ARGS__)
#define glGetDebugMessageLog(...) GLEGetCurrentFunction(glGetDebugMessageLog, __VA_ARGS__)
#define glGetObjectLabel(...) GLEGetCurrentFunction(glGetObjectLabel, __VA_ARGS__)
#define glGetObjectPtrLabel(...) GLEGetCurrentFunction(glGetObjectPtrLabel, __VA_ARGS__)
#define glObjectLabel(...) GLEGetCurrentFunction(glObjectLabel, __VA_ARGS__)
#define glObjectPtrLabel(...) GLEGetCurrentFunction(glObjectPtrLabel, __VA_ARGS__)
#define glPopDebugGroup(...) GLEGetCurrentFunction(glPopDebugGroup, __VA_ARGS__)
#define glPushDebugGroup(...) GLEGetCurrentFunction(glPushDebugGroup, __VA_ARGS__)
...
height, GLenum format, GLenum type, GLsizei bufSize, void *data);
    ...
    #define glGetnUniformuiv(...) GLEGetCurrentFunction(glGetnUniformuiv, __VA_ARGS__)
...
#define glAddSwapHintRectWIN(...) GLEGetCurrentFunction(glAddSwapHintRectWIN, __VA_ARGS__)
...
#define glXGetCurrentDisplay(...) GLEGetCurrentFunction(glXGetCurrentDisplay, __VA_ARGS__)
#endif
...
#define glXChooseFBConfig(...) GLEGetCurrentFunction(glXChooseFBConfig, __VA_ARGS__)
#define glXCreateNewContext(...) GLEGetCurrentFunction(glXCreateNewContext, __VA_ARGS__)
#define glXCreatePbuffer(...) GLEGetCurrentFunction(glXCreatePbuffer, __VA_ARGS__)
#define glXCreatePixmap(...) GLEGetCurrentFunction(glXCreatePixmap, __VA_ARGS__)
#define glXCreateWindow(...) GLEGetCurrentFunction(glXCreateWindow, __VA_ARGS__)
#define glXDestroyPbuffer(...) GLEGetCurrentFunction(glXDestroyPbuffer, __VA_ARGS__)
#define glXDestroyPixmap(...) GLEGetCurrentFunction(glXDestroyPixmap, __VA_ARGS__)
#define glXDestroyWindow(...) GLEGetCurrentFunction(glXDestroyWindow, __VA_ARGS__)
#define glXGetCurrentReadDrawable(...) GLEGetCurrentFunction(glXGetCurrentReadDrawable, __VA_ARGS__)
#define glXGetFBConfigAttrib(...) GLEGetCurrentFunction(glXGetFBConfigAttrib, __VA_ARGS__)
#define glXGetFBConfigs(...) GLEGetCurrentFunction(glXGetFBConfigs, __VA_ARGS__)
#define glXGetSelectedEvent(...) GLEGetCurrentFunction(glXGetSelectedEvent, __VA_ARGS__)
#define glXGetVisualFromFBConfig(...) GLEGetCurrentFunction(glXGetVisualFromFBConfig, __VA_ARGS__)
#define glXMakeContextCurrent(...) GLEGetCurrentFunction(glXMakeContextCurrent, __VA_ARGS__)
#define glXQueryContext(...) GLEGetCurrentFunction(glXQueryContext, __VA_ARGS__)
#define glXQueryDrawable(...) GLEGetCurrentFunction(glXQueryDrawable, __VA_ARGS__)
#define glXSelectEvent(...) GLEGetCurrentFunction(glXSelectEvent, __VA_ARGS__)
...
#define glXCreateContextAttribsARB(...) GLEGetCurrentFunction(glXCreateContextAttribsARB, __VA_ARGS__)
...
#define glXSwapIntervalEXT(...) GLEGetCurrentFunction(glXSwapIntervalEXT, __VA_ARGS__)
...
#define glXGetMscRateOML(...) GLEGetCurrentFunction(glXGetMscRateOML, __VA_ARGS__)
#define glXGetSyncValuesOML(...) GLEGetCurrentFunction(glXGetSyncValuesOML, __VA_ARGS__)
#define glXSwapBuffersMscOML(...) GLEGetCurrentFunction(glXSwapBuffersMscOML, __VA_ARGS__)
#define glXWaitForMscOML(...) GLEGetCurrentFunction(glXWaitForMscOML, __VA_ARGS__)
#define glXWaitForSbcOML(...) GLEGetCurrentFunction(glXWaitForSbcOML, __VA_ARGS__)
...
#define glXGetSwapIntervalMESA(...) GLEGetCurrentFunction(glXGetSwapIntervalMESA, __VA_ARGS__)
#define glXSwapIntervalMESA(...) GLEGetCurrentFunction(glXSwapIntervalMESA, __VA_ARGS__)
